...
public class Main {
    ...
    public static Person createPerson(String today) {
        ...
        JOptionPane.showMessageDialog(null, "Hello! Today, " + today + ", is a fabulous day! \n"
        ...
        if (selectedMeasurement.equals("Inches/Pounds")) {
            ...
            while (height < 91 || height > 254) {
                height = Integer.parseInt(JOptionPane.showInputDialog("That is invalid! Please enter your height in centimeters (no decimals): "));
            }
            ...
            while (weight < 20 || weight > 680) {
                weight = Integer.parseInt(JOptionPane.showInputDialog("That is invalid! Please enter your weight in kilograms (no decimals): "));
            }
        ...
        while (goal < 0) {
            goal = Integer.parseInt(JOptionPane.showInputDialog("That is an invalid number\nPlease enter your desired calorie intake per day: "));
        }
        ...
        if (addWaterGoal == JOptionPane.YES_OPTION) {
            waterGoal = Integer
                    .parseInt(JOptionPane.showInputDialog("Please enter your desired water intake per day in ounces: "));
            while (waterGoal < 0) {
                waterGoal = Integer
                        .parseInt(JOptionPane.showInputDialog("That is an invalid number\\nPlease enter your desired water intake per day in ounces: "));
            ...
            switch (choice) {
                ...
                case 1:
                    ...
                    while (calChoice != 1 && calChoice != 2) {
                        calChoice = Integer.parseInt(JOptionPane.showInputDialog("Enter number 1 or 2." +
                                "Options: \n" + "1. Add Calories \n" + "2. Decrease Calories through Exercise "));
                    }
                    if (calChoice == 1) {
                ...
                default:
                        JOptionPane.showMessageDialog(null, "\tEND OF DAY REPORT:\n" + user.displayInfo(), today ,JOptionPane.INFORMATION_MESSAGE);       
                        
                        if (food.size() > 0) {
                        	JOptionPane.showMessageDialog(null, user.getFoodBreakdown());
                        	int seeFoodReport =  JOptionPane.showConfirmDialog(null, "Would you like to view a list of what you ate today?",
                             "", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
                    ...
                    switch (profileOption) {
                        ...
                        case 1:
                            ...
                            if(user.getSelectedMeasurement().equals("Inches/Pounds")) {
                                ...
                                JOptionPane.showMessageDialog(null, message + "Your weight has been updated to " + weight + " pounds!");
                            }
                            else {
                                int weight = Integer
                                ...
                                user.setWeight((weight));
                              //message for losing weight / empty message if didn't lose weight  
                                message = oldWeight > weight ? "You lost " + (oldWeight - weight) + " kilogram(s)!\nKeep it up!!": "";
                                JOptionPane.showMessageDialog(null, message + "Your weight has been updated to " + weight + " kilograms!");
                            }
    ...
    public static void addWater(Person user) {
        ...
        while (water < 0) {
        	 water = Double.parseDouble(JOptionPane.showInputDialog("Invalid Number\nPlease enter water intake in oz: "));
        }
