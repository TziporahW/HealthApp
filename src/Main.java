...
public class Main {
    ...
    public static void menu(Person user, ArrayList<String> food, String today) {
        ...
        do {
            ...
            switch (choice) {
                ...
                default:
                    endDay(user, food, today);
            }

        } while (choice != 6);
    }

    public static void endDay(Person user, ArrayList<String> food, String today){
    ...
    public static void changeInCalories(Person user, ArrayList<String> food){
    ...
    public static void updateWeight(Person user){
    ...
    public static void updateHeight(Person user){
        if (user.getSelectedMeasurement().equals("Inches/Pounds")) {
            int height = Integer
